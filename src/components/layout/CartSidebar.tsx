...
export function CartSidebar() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed top-0 right-0 z-[90] flex h-full w-full max-w-md flex-col bg-dark-elevated border-l border-white/10 transition-transform duration-500 ease-out",
                  ...
                  <div className="flex flex-1 flex-col">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        className="shrink-0 rounded-lg p-1 text-gray-500 hover:bg-red-500/10 hover:text-red-400"
